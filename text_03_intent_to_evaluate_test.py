...
file = "/Users/pat/Library/CloudStorage/Dropbox/2021_ARC_Pathways to Power/Legislative Quality/Methodology/data/text/text_03_intent_human_flan_test.rds"
...
outfile = file.replace("text_03_intent_human_flan_test.rds", "text_03_flan_test.csv")
...
df = df.loc[:,['austlii_id', 'text', 'intent_to_evaluate_0', 'flan_class']]
 
df.to_csv(outfile, index = False)


# # contingency table to see how we did...
# 
# import pandas as pd
#  
# data_crosstab = pd.crosstab(df['intent_to_evaluate'],
#                             df['flan_class'], 
#                                margins = False)
# print(data_crosstab)
# print(input_text[2])
