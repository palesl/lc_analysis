...
outfile = file.replace("text_03_intent_flan_full.rds", "text_05_flan_recommend_test.csv")
...
input_text = [ class_req + df["law"][idx] + class_post +"\""+ df["text"][idx] + "\"" for idx in newrange]
